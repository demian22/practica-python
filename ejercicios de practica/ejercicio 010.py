...
(no necesariamente enpartes iguales).

Calcular qué porcentaje invirtió cada una.

Como pensarlo:
1 Solicitar al usuario que ingrese las cantidades invertidas por cada persona
en tres variables numéricas.
...
3 Calcular el porcentaje que representa la inversión de cada persona en
relación al total de la inversión.

3 - 1 Dividir la cantidad invertida por cada persona entre el total de la
inversión y multiplicar por 100 para obtener el porcentaje. Almacenar el
resultado en una variable correspondiente a cada persona. Opcionalmente,
se puede redondear el resultado a un número determinado de decimales 
...
inversion_persona1 = float(input("inversion persona1: "))
inversion_persona2 = float(input("inversion persona2: "))
inversion_persona3 = float(input("inversion persona3: "))
total = (inversion_persona1 + inversion_persona2 + inversion_persona3)
...
print("porcentaje de invercion persona1: " , porcentaje_inversion_persona1 , )
print("porcentaje de invercion persona2: " , porcentaje_inversion_persona2 , )
print("porcentaje de invercion persona3: " , porcentaje_inversion_persona3 , )
